...
$sql = "SELECT customer.name as cname, transaction.* FROM customer INNER JOIN transaction ON customer.id = transaction.customer_id";
...
<body>
    ...
    <main>
        <div class="container mt-5">
            <div class="row">
                <div class="col-2">
                    <a class="btn text-light mb-3" href="create_transaction.php" style="background-color: rgba(28, 125, 49, 0.7);">Tambah Transaksi</a>
                </div>
                <div class="col-10">
